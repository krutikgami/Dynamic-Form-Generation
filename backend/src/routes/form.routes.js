...
import { createForm,publishForm,getFormsById,updateForm,formSubmissions,viewForm,getFormSubmissionData,updateUserSubmissionData ,getFormSchema,deleteUserSubmission,deleteAdminForm} from '../controllers/form.controller.js'
...
router.delete('/form',adminAuthMiddleware,deleteAdminForm);
...
router.patch('/form/submission',userLoginAuthMiddleware,updateUserSubmissionData);
router.post('/form/schema',userLoginAuthMiddleware,getFormSchema)
router.delete('/form/submission',adminAuthMiddleware,deleteUserSubmission);
